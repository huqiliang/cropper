...
var Croper = (function() {
    ...
    return {
        setbili:function(width,height){
           this.bili = width / height;
           dodo(this.bili)
        },
...
// -----------logic--------------
// ------------------------------
var set_w_h_btn = $("#set_w_h_btn");
var container = $('.uploader-container');
var filepick='<div id="filePicker">选择文件</div>';

set_w_h_btn.click(function() {
    var img_width = $("#set_width").val();
    var img_height = $("#set_height").val();
    if($(this).text()=="确定"){
        $('.img-preview').css({
            width: img_width,
            height: img_height
        ...
        $(this).text('重设')
        $("#set_width,#set_height").css("background","#ccc").attr("readonly","readonly");
        container.append(filepick)
        Uploader.init(function( src ) {

            Croper.setbili( img_width,img_height );
        ...
        $("#filePicker").remove()
        $(this).text('确定')
        $("#set_width,#set_height").css("background","#fff").removeAttr("readonly");
